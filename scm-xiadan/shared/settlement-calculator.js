...
class SettlementCalculator {
  ...
  calculateNetAmount(normalAmount, chargebackAmount) {
    ...
    } else if (typeof normalAmount !== 'number' || isNaN(normalAmount) || !isFinite(normalAmount)) {
    ...
    } else if (typeof chargebackAmount !== 'number' || isNaN(chargebackAmount) || !isFinite(chargebackAmount)) {
